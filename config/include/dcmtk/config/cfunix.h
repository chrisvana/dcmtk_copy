...
#define CANONICAL_HOST_TYPE "i386-apple-darwin13.4.0"
...
#define DCM_DICT_DEFAULT_PATH "//share/dcmtk/dicom.dic"

/* Define the default directory where configuration files reside. */
#define DEFAULT_CONFIGURATION_DIR "//etc/dcmtk/"

/* Define the default directory where support data files reside. */
#define DEFAULT_SUPPORT_DATA_DIR "//share/dcmtk/"
